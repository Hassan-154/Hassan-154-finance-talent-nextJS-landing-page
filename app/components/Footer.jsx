      ...
      <div className=' flex flex-col lg:flex-row gap-[25px] lg:gap-[10px] pt-[30px] sm:pt-[50px] pb-[15px] sm:pb-[30px] justify-center px-3 sm:px-4 xl:px-0'>
        <div className='w-full lg:w-[45%]'>
          <div className='flex flex-col gap-2 sm:gap-3'>
            <h2 className="text-xl sm:text-2xl font-bold text-black ">LOGO</h2>
        ...
        <div className='flex flex-row w-full lg:w-[55%]'>
            ...
            <ul className='flex flex-col gap-0 md:gap-2'>
              {navData.menuItems.map((item, index) => (
                <li key={index}> <a
                  ...
                  href={item.link}
                  className=" hover:text-gray-700 block lg:inline sm:px-3 py-1 md:py-2 lg:p-0 text-base lg:text-[15px] lg:font-thin"
                >
                  {item.name}
                </a></li>
              ))}
