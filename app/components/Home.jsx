...
function Home() {
    return (
        <div className='lg:h-[80vh] max-w-6xl mx-auto flex flex-col lg:flex-row lg:gap-[10px] items-center justify-center px-3 sm:px-4 lg:px-0'>
            <div className='w-2/2 lg:w-1/2 flex flex-col gap-[20px]'>
                ...
                <div className='flex gap-3'>
                    <Button title="Join as a Candidate" className="bg-periwinkle-blue text-white" />
                    <Button title="I’m a Recruiter" className="bg-slate-light text-black" />
                </div>
